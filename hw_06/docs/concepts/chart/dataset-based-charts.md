---
title: "Чарты в визарде {{ datalens-full-name }}"
description: "Из статьи вы узнаете, что такое визард и чарт в {{ datalens-full-name }}, а также познакомитесь с интерфейсом визарда."
---

# Чарты в визарде {{ datalens-full-name }}
