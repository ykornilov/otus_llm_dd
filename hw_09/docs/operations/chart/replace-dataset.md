---
title: "Как заменить датасет в чарте {{ datalens-full-name }}"
description: "Следуя данной инструкции, вы сможете заменить датасет в чарте {{ datalens-full-name }}." 
---

# Замена датасета в чарте {{ datalens-full-name }}
